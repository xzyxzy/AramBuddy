    ...
    internal class Collision
    {
        ...
        private static void Game_OnTick(EventArgs args)
        {
            ...
            foreach (var spell in KappaEvade.DetectedSpells)
            {
                ...
                {
                    objects.AddRange(EntityManager.Heroes.AllHeroes.OrderBy(s => s.Distance(spell.Start)).Where(o => o != null && spell.Caster != null && !o.IsMe && o.Team != spell.Caster?.Team && o.IsValidTarget() && poly.IsInside(o) && spell.spell.Collisions.Contains(Database.SkillShotSpells.Collision.Heros)));
                    objects.AddRange(EntityManager.MinionsAndMonsters.Combined.OrderBy(s => s.Distance(spell.Start)).Where(o => o != null && spell.Caster != null && o.Team != spell.Caster?.Team && o.IsValidTarget() && poly.IsInside(o) && spell.spell.Collisions.Contains(Database.SkillShotSpells.Collision.Minions)));
